...
@DirtiesContext
public class CamelAMQ2WMQXAPerformanceTest extends CamelSpringTestSupport {
...
//        wmqConnectionFactory.setUseConnectionPooling(true);
    ...
    /* Move messages from Active MQ to Websphere MQ using JTA/XA transactions. */
    @Test
    public void testReadAndStoreAMQ2WMQ() throws Exception {
        System.out.println("testReadAndStoreAMQ2WMQ");
        ...
        context.addRoutes(new SpringRouteBuilder() {
            public void configure() throws Exception {
                from("amqxa:queue:test")
                        ...
                        .to("wmqxa:SMRV.TO.CORONA");
            }
        });

        System.out.println("Latch is waiting.");
        assertTrue(latch.await(60, TimeUnit.SECONDS));
        System.out.println("testReadAndStoreXAAMQ2WMQ consumed " + counter + " messages in " + (System.currentTimeMillis() - millis) + " ms.");
    }
